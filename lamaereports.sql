...
CREATE TABLE `lamaereports` (
  ...
  `details` text,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=257 DEFAULT CHARSET=tis620;
...
INSERT INTO lamaereports VALUES ('253', '7', 'รายงานจ่ายยานอกเวลา(20.00น.-07.59น.)ที่ห้องอุบัติเหตุฉุกเฉิน (เฉพาะวันราชการ ไม่รวมวันหยุด)', 'form1', 'report7', '2016-10-07', 'enable', 'emergen', null);
INSERT INTO lamaereports VALUES ('254', '7', 'รายงานจ่ายยานอกเวลา(16.00น.-07.59น.)ที่ห้องอุบัติเหตุฉุกเฉิน (เฉพาะวันหยุดราชการ)', 'form1', 'report8', '2016-10-10', 'enable', 'emergen', null);
INSERT INTO lamaereports VALUES ('246', '8', 'รายงานจ่ายยานอกเวลา 16.01น.-07.59น.', 'form1', 'report7', '2016-10-06', 'enable', 'pharmacy', null);
