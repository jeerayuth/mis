...
CREATE TABLE `lamaereports` (
  ...
  `details` text,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=306 DEFAULT CHARSET=tis620;
...
INSERT INTO lamaereports VALUES ('291', '7', 'รายงานผู้ป่วยนอกทั้งหมด RE-VISIT ภายใน 48 ชั่วโมง', 'form1', 'report10', '2016-11-15', 'enable', 'emergen', null);
...
INSERT INTO lamaereports VALUES ('298', '3', 'รายงานจำนวนคนไข้คลินิกเบาหวาน ได้รับการ admit', 'form3', 'report18', '2016-11-23', 'enable', 'dm', null);
