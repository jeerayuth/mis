...
class HearthController extends CommonController {
    public $dep_controller = 'hearth';

    public function actionReport1() {
        $this->SaveLog($this->dep_controller, 'report1', $this->getSession());    
            // ตัวแปร $report_name เอาไว้ไปแสดงชื่อรายงานในหน้า view
                $report_name = 'รายงานสรุปคนไข้ทะเบียนคลินิกโรคหัวใจ แยกตามที่อยู่ในแต่ละสถานบริการ(คน)';
                $uclinic = '015';
    ...
    public function actionReport2($hosp_area, $uclinic) {
        ...
        if ($uclinic != "" && $hosp_area != "") {
                ...
                $report_name = 'รายงานรายชื่อคนไข้ทะเบียนคลินิกโรคหัวใจ แยกตามที่อยู่ในแต่ละสถานบริการ(คน)';
