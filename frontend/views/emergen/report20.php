...
$this->registerJs(" 
    ...
    $('#chart').highcharts({
        ...
        title: {
            text: 'รายงานจำนวนครั้งผู้รับบริการในกลุ่มผู้ป่วยกระดูกหัก (แบบ Open) ที่ห้องอุบัติเหตุฉุกเฉิน'
        },
    ...
    'columns' => [
        ...
        [
            ...
            'value' => function($model) use ($datestart, $dateend, $report_name) {
                ...
                return Html::a(Html::encode($count_vn), ['emergen/report21', 'er_dch_type' => $er_dch_type, 'datestart' => $datestart, 'dateend' => $dateend, 'report_name' => $report_name], ['target' => '_blank']);
            }
                ]
            ]
        ])
