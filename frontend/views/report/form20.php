                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-6 col-md-offset-3">
                            <select id="clinic" class="form-control">
                                ...
                                <option value="2">คนไข้เฉพาะในคลินิก COPD</option>
                            </select> 
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function url() {
        ...
        window.open('http://192.168.1.252:8080/mis/frontend/web/index.php?r=<?= $ctrl ?>/<?= $point ?>&uclinic=' + uclinic + '&datestart=' + datestart + '&dateend=' + dateend + '&details=<?= $details; ?>');
    }
