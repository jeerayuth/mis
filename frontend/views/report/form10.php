                ...
                <form novalidate="" id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                        <div class="col-md-3 col-sm-3 col-xs-6 col-md-offset-3">
                            <select id="refer_type_id" class="form-control">
                                <option value="">กรุณาเลือกประเภทการส่งต่อ</option>  
                                <option value="all">ทั้งหมด</option>
                                <option value="1">รับส่งภายในจังหวัด</option>
                                <option value="2">รับส่งนอกจังหวัด</option>
                                <option value="0">รับส่งจาก CUPs</option>
                            </select>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function url() {
        ...
        var e = document.getElementById("refer_type_id");
        var refer_type_id = e.options[e.selectedIndex].value;
        ...
        if(d1 == '' || d2 == '')  {
            alert('กรุณาเลือกช่วงวันที่ที่ต้องการดูรายงาน');
            return false;
        }
        
        if(refer_type_id =='') {
            alert('กรุณาเลือกประเภทการส่งต่อที่ต้องการดูรายงาน');
            return false;
        }

        window.open('http://192.168.1.252:8080/mis/frontend/web/index.php?r=<?= $ctrl ?>/<?= $point ?>&refer_type_id=' + refer_type_id + '&datestart=' + datestart + '&dateend=' + dateend + '&details=<?= $details; ?>');
    }
