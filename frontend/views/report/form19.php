                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-6 col-md-offset-3">
                            <select id="clinic" class="form-control">
                                ...
                                <option value="1">คนไข้ Asthma ทั้งหมด (รวมที่เป็น DM,HT)</option>
                                <option value="2">คนไข้ Asthma อย่างเดียว (ไม่เป็น DM,HT)</option>  
                                <option value="3">คนไข้ Asthma WITH DM (WITH DM,NO HT)</option>
                                <option value="4">คนไข้ Asthma WITH HT (WITH HT,NO DM)</option>
                            </select> 
                        </div>
