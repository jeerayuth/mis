                    ...
                    <div class="form-group">
                        <div class="col-md-3 col-sm-3 col-xs-6 col-md-offset-3">
                            <select id="items" class="form-control">
                                <option value="">กรุณาระบุ State</option>
                                <option value="A01">State A</option>
                                <option value="B01">State B</option>
                                <option value="C01">State C</option>
                                <option value="D01">State D</option>          
                            </select> 
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function url() {
        ...
        var item = l.options[l.selectedIndex].value;
        ...
        window.open('http://192.168.1.252:8080/mis/frontend/web/index.php?r=<?= $ctrl ?>/<?= $point ?>&datestart=' + datestart + '&dateend=' + dateend + '&details=<?= $details; ?>' + '&item=' + item);
    }
