            ...
            <div class="x_panel">
                ...
                <form novalidate="" id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left">
                   ...
                   <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">เลือกวันที่ <span class="required">*</span>
                        </label>
...
<script type="text/javascript">
    ...
    function url() {
        ...
        window.open('http://192.168.1.252:8080/mis/frontend/web/index.php?r=<?= $ctrl ?>/<?= $point ?>&datestart=' + datestart + '&details=<?= $details; ?>');
    }
