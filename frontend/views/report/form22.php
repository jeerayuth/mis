            ...
            <div class="x_panel">
                ...
                <form novalidate="" id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">ช่วงเวลา <span class="required">*</span>
                        </label>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <input type="text" class="form-control" id="time1" name="time1" placeholder="เวลาเริ่มต้น=>ชั่วโมง:นาที:วินาที เช่น 08:00:00"> 
                            <input type="text" class="form-control" id="time2" name="time2" placeholder="เวลาสิ้นสุด=>ชั่วโมง:นาที:วินาที เช่น 16:30:00" >
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function url() {
        ...
        window.open('http://192.168.1.252:8080/mis/frontend/web/index.php?r=<?= $ctrl ?>/<?= $point ?>&datestart=' + datestart + '&dateend=' + dateend + '&timestart=' + timestart +  '&timeend=' + timeend + '&details=<?= $details; ?>');
    }
