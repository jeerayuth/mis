                ...
                <form novalidate="" id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                        <div class="col-md-3 col-sm-3 col-xs-6 col-md-offset-3">
                            <?php echo Html::dropDownList('pttype', null,
                                ArrayHelper::map(Pttype::find()->all(), 'pttype', 'name'), [
                              // 'multiple' => 'multiple',
                                'class' => 'form-control',
                                'id' => 'pttype',
                                'prompt' => ' -- กรุณาเลือกสิทธิ์ที่ต้องการดูรายงาน --'
                          ]) ?>
...
<script type="text/javascript">
    ...
    function url() {
        ...
        var e = document.getElementById("pttype");
        var pttype = e.options[e.selectedIndex].value;
        ...
        if(pttype == "") {
            alert("กรุณาเลือกสิทธิ์การรักษาที่ต้องการดูรายงานด้วยครับ");
            return false;
        }

        window.open('http://192.168.1.252:8080/mis/frontend/web/index.php?r=<?= $ctrl ?>/<?= $point ?>&pttype=' + pttype + '&datestart=' + datestart + '&dateend=' + dateend + '&details=<?= $details; ?>');
    }
