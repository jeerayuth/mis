                ...
                <form novalidate="" id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-6 col-md-offset-3">
                            <select id="totalid" class="form-control">
                                <option value="">กรุณาเลือกประเภทจำนวน</option>
                                <option value="1">จำนวนครั้ง</option>
                                <option value="2">จำนวนคน</option>
                            </select> 
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function url() {
        ...
        var totalid = e.options[e.selectedIndex].value;
        ...
        window.open('http://192.168.1.252:8080/mis/frontend/web/index.php?r=<?= $ctrl ?>/<?= $point ?>&totalid=' + totalid + '&datestart=' + datestart + '&dateend=' + dateend + '&details=<?= $details; ?>');
    }
