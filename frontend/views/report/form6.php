                    ...
                    <div class="form-group">
                        <div class="col-md-3 col-sm-3 col-xs-6 col-md-offset-3">
                            <select id="lab_items" class="form-control">
                                ...
                                <option value="1">GFR</option>
                                <option value="2">Urine Protein</option>
                                <option value="3">Lipid Profile</option>
                                <option value="4">Glucose(FPG)</option>
...
<script type="text/javascript">
    ...
    function url() {
        ...
        window.open('http://192.168.1.252:8080/mis/frontend/web/index.php?r=<?= $ctrl ?>/<?= $point ?>&datestart=' + datestart + '&dateend=' + dateend + '&details=<?= $details; ?>' + '&operators=' + operators + '&result_first=' + result_first + '&lab_items=' + lab_items);
    }
