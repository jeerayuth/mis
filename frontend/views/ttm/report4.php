...
for ($i = 0; $i < count($rawData_graph); $i++) {
    $data[] = [
        'name' => $rawData_graph[$i]['drug_name'],
...
echo GridView::widget([
    ...
    'columns' => [
        ...
        [
         ...
         [
            'attribute' => 'sum_cost',
            'header' => 'มูลค่าการใช้ยาแพทย์แผนไทยราคาทุน(บาท)'
        ],
        [
            'attribute' => 'sum_price',
            'header' => 'มูลค่าการใช้ยาแพทย์แผนไทยราคาขาย(บาท)'
        ],
