    ...
    'columns' => [
        ...
        [
            ...
            'value' => function($model) use ($date_start, $date_end) {
                ...
                return Html::a(Html::encode($title), ['claim/report28', 'head' => $head, 'ptt_code' => $ptt_code, 'ptt_type' => $ptt_type, 'date_start' => $date_start, 'date_end' => $date_end, 'cup_status' => $cup_status], ['target' => '_blank']);
            }
                ]
            ]
        ])
